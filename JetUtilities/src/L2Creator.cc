...
#include "JetMETAnalysisMCtruth/JetUtilities/interface/L2Creator.hh"
    ...
    while ((hrsp=hl_rsp.next_object(indices))) {
	    ...
	    cout << "" << endl;
            ...
            //xmin = max(gabscor->GetX()[0],3.0);
                ...
                gabscor->Sort();
                xmin = max(gabscor->GetX()[0],10.0); //start of fit 10 GeV
		...
		/*	if(ieta==2 || ieta==8 || ieta==17 || ieta==18 || ieta==29 || ieta==33 || ieta==40 || ieta==43 || ieta==50 || ieta==52 || ieta==64 || ieta==75 || ieta==77 || ieta==79)
			{
				fabscor->SetParameter(0,-0.0221278);
        			...
        			fabscor->SetParameter(4,2.82597);
       				fabscor->SetParLimits(4,-100,500);
			...
			if(ieta==35 || ieta==36)
			{
				fabscor->SetParameter(0,0.0221278);	
        			...
        			fabscor->SetParameter(1,100.);
        			fabscor->SetParLimits(1,0,500);
        			fabscor->SetParameter(2,50);
        			fabscor->SetParLimits(2,-200,500);
        			fabscor->SetParameter(3,-0.0679365);
        			fabscor->SetParLimits(3,-15,15);
        			fabscor->SetParameter(4,5.);
        			fabscor->SetParLimits(4,0,50);
			...
			if(ieta==3)
			{
				fabscor->SetParameter(0,0.0221278);	
        			...
        			fabscor->SetParLimits(1,-100,1000);
        			fabscor->SetParameter(2,50);
        			fabscor->SetParLimits(2,-200,500);
        			fabscor->SetParameter(3,-0.0679365);
        			fabscor->SetParLimits(3,-15,15);
...
*/
	    ...
	    std::cout<<"Chi2 = "<<fabscor->GetChisquare()<<" , NDF = "<<fabscor->GetNDF()<<std::endl;
