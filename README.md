...
If you get a compilation error about "is_invocable_v<const _Compare&, const _Key&, const _Key&>", then open the file CMSSW_12_4_3/tmp/slc7_amd64_gcc10/src/JetMETAnalysis-MC-truth/JetUtilities/src/JetMETAnalysis-MC-truthJetUtilities/a/JetMETAnalysis-MC-truthJetUtilities_xr.cc and before any other include (among L6 and L7) add the following line: \
#include "JetMETAnalysis-MC-truth/JetUtilities/interface/stl_tree.h"
