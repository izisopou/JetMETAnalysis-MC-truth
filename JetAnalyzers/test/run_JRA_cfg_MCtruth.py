...
conditionsSource = "GT"
era = "" #it doesn't matter what you put here
doProducer = False
...
process.GlobalTag.globaltag = cms.string('130X_mcRun3_2023_realistic_v14') 
...
##############################################
try:
    process.load("JetMETAnalysisMCtruth.JetAnalyzers.<filename without extension>")
except ImportError:
...
#!
import JetMETAnalysisMCtruth.JetAnalyzers.Defaults_cff as Defaults
...
from JetMETAnalysisMCtruth.JetAnalyzers.addAlgorithm import addAlgorithm
