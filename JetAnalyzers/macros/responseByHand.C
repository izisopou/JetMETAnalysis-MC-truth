...
void compareErasNoPU(bool PU = false, TString algo = "ak4pfchs", TString var = "resp", int ptlow = 20, int pthigh = 40,bool debug = false){
    ...
    gROOT->LoadMacro("$CMSSW_BASE/src/JetMETAnalysisMCtruth/JetAnalyzers/interface/Settings.h");
    setTDRStyle();
    ...
    TFile* f74;
    if(!PU)
       f74 = TFile::Open("/home/aperloff/JEC/CMSSW_7_4_0_pre9/src/JetMETAnalysisMCtruth/JetAnalyzers/test/JRA_HS.root","READ");
    else
       return;
       //f74 = TFile::Open("/home/aperloff/JEC/CMSSW_7_4_0_pre9/src/JetMETAnalysisMCtruth/JetAnalyzers/test/JRA_HS.root","READ");
    f74->cd(algo);
    ...
    if(!PU)
       ...
       return;
       //f73 = TFile::Open("/home/aperloff/JEC/CMSSW_7_4_0_pre9/src/JetMETAnalysisMCtruth/JetAnalyzers/test/JRA_HS.root","READ");
    f73->cd(algo);
