...
#include "JetMETAnalysisMCtruth/JetAnalyzers/interface/VectorWrapper.h"
#include "JetMETAnalysisMCtruth/JetAnalyzers/interface/VectorWrapper2D.h"
...
#include "JetMETAnalysisMCtruth/JetUtilities/interface/ProgressBar.hh"
...
//#include "JetMETAnalysisMCtruth/JetAnalyzers/XrdClFileSystem_v2.hh"
#define has_xrdcl 1
#else
#define has_xrdcl 0
#endif
...
int main(int argc,char**argv)
{
   ...
   //ofstream textfile;
   //textfile.open("/afs/cern.ch/work/i/izisopou/public/JEC_Run3/CMSSW_12_2_1/src/condor_AK4CHS/Events_with_zero_response_Run3Winter22_noPUreweight.txt");
   ...
   for(unsigned int a=0; a<algs.size(); a++) {
      ...
      vector<string> branch_names = {"nref","refpt","refeta","jtpt","jteta","jtphi","jtarea",
                                     ...
                                     "refpdgid","npv","rho","rho_hlt","pthat","weight","recopvz","genpvz","jtnMult"};
...
//	    if(JRAEvt->npv>0 && JRAEvt->npv<10){  //nVtx cut starts here
	    ...
	    scaleL1andL2L3 = JetCorrector->getSubCorrections();
	    float scaleL1 = scaleL1andL2L3.at(0);
	    if((pt*scaleL1)<1) continue;
	    */
