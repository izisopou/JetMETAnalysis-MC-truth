...
def addAlgorithm(process, alg_size_type_corr, Defaults, reco, doProducer):
    ...
    if correctl1 or correctl2l3:
        process.load('JetMETAnalysisMCtruth.JetAnalyzers.JetCorrection_cff')
    ...
    if type == 'JPT':
        ...
        process.load('JetMETAnalysisMCtruth.JetAnalyzers.JPTReconstruction_cff')
        if   alg_size == 'ak4':
...
#            sequence = cms.Sequence(process.ak7JPTJetsSequence * sequence)
        ...
        if type == 'Track':
            process.load('JetMETAnalysisMCtruth.JetAnalyzers.TrackJetReconstruction_cff')
...
#
    ...
    jra = cms.EDAnalyzer(jraAnalyzer,
                         ...
                         srcgenVtx         = cms.InputTag('genParticles:xyz0'),
